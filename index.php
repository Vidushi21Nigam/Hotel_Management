...
<div class="swiper swiper-container">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <img src="images/carousel/img4.png" />
      </div>
      <div class="swiper-slide">
        <img src="images/carousel/img5.png" />
      </div>
      <div class="swiper-slide">
        <img src="images/carousel/img6.png" />
      </div>
    </div>
...
<div class="d-flex justify-content-evenly mb-4">
      <a href="booking.php" class="btn btn-sm text-white custom-bg">Book Now</a>
...
<div class="col-lg-2 me-1 col-md-6 text-center bg-white rounded shadow py-4 my-3">
...
<div class="swiper swiper-testimonials">
  <div class="swiper-wrapper mb-5">
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam totam, ipsam fuga ea magni quas nam expedita voluptas libero aut, saepe illo aperiam blanditiis maiores quam, animi nobis sunt repellat.</p>
    <div class="rating">
    <i class="bi bi-star-fill text-warning"></i>
    <i class="bi bi-star-fill text-warning"></i>
    <i class="bi bi-star-fill text-warning"></i>
...
<div class="bg-white p-4 rounded mb-4">
  <h5> Call Us</h5>
  <a href="tel: +<?php echo $contact_r['pn1']?>" class="d-inline-block mb-2 text-decoration-none text-dark"> <i class="bi bi-telephone"></i>+<?php echo $contact_r['pn1']?>
  </a>
  <br>
  <a href="tel: +917899568793" class="d-inline-block text-decoration-none text-dark"> <i class="bi bi-telephone"></i>+917899568793 
  </a>
</div>
<div class="bg-white p-4 rounded mb-4">
  <h5>Follow Us</h5>
